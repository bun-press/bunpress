...
export const DEFAULT_WATCH_OPTIONS: WatchOptions = {
  ignored: ['**/node_modules/**', '**/.git/**', '**/dist/**', '**/*.js.map', '**/*.d.ts'],
  debounceTime: 100,
  options: {
    recursive: true,
    persistent: true,
...
export async function watchDirectory(
  ...
  return await tryCatch(
    async () => {
      ...
      const watcher = watch(directoryPath, { recursive: true, ...options.options }, watchListener);
 ...
 * @returns File watcher instance
 */
export function createBasicWatcher(paths: string | string[]): FileWatcher {
