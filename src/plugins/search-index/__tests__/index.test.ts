...
describe('Search Index Plugin', () => {
  ...
  test('should extract excerpts correctly', () => {
    ...
    // Test truncation
    expect(plugin.__test__.extractExcerpt('<p>This is a longer text that should be truncated</p>', 10))
      .toBe('This is a ...');
    
    // Test with HTML
    expect(plugin.__test__.extractExcerpt('<h1>Title</h1><p>Content with <strong>bold</strong> text.</p>', 20))
