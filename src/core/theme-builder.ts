 ...
 */
export async function buildTheme(theme: Theme, config: BunPressConfig): Promise<any> {
  ...
  try {
    ...
    // Bundle theme assets
    const result = await bundleAssets([...theme.scripts, ...theme.styles], themeOutputDir, config, {
 ...
 * @param config BunPress configuration
 */
export async function copyThemeAssets(theme: Theme, config: BunPressConfig): Promise<void> {
